...
class SettlementResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'work_duration_days' => $this->work_start_date && $this->work_completion_date ?
                $this->work_start_date->diffInDays($this->work_completion_date) : null,
            ...
            'days_until_due' => $this->payment_due_date?->diffInDays(now(), false),
