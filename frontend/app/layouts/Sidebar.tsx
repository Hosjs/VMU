...
export function Sidebar({ isOpen, onClose, user }: SidebarProps) {
    ...
    switch (roleName) {
      case 'admin':
        return [
          ...
          { title: 'Đơn hàng', path: '/admin/orders', icon: <Icon d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />, badgeKey: 'orders' },
          { title: 'Hóa đơn', path: '/admin/invoices', icon: <Icon d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />, badgeKey: 'invoices' },
          ...
          { title: 'Yêu cầu dịch vụ', path: '/admin/service-requests', icon: <Icon d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />, badgeKey: 'service_requests' },
      ...
      case 'manager':
        return [
          ...
          { title: 'Đơn hàng', path: '/manager/orders', icon: <Icon d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />, badgeKey: 'orders' },
      ...
      case 'accountant':
        return [
          ...
          { title: 'Hóa đơn', path: '/accountant/invoices', icon: <Icon d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />, badgeKey: 'invoices' },
      ...
      case 'mechanic':
        return [
          ...
          { title: 'Lệnh sửa chữa', path: '/mechanic/work-orders', icon: <Icon d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />, badgeKey: 'work_orders' },
          { title: 'Yêu cầu dịch vụ', path: '/mechanic/service-requests', icon: <Icon d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />, badgeKey: 'service_requests' },
        ];
      ...
      case 'employee':
        return [
          ...
          { title: 'Công việc', path: '/employee/tasks', icon: <Icon d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />, badgeKey: 'work_orders' },
        ];
  ...
  return (
    <>
      ...
      {/* Overlay cho mobile - Click ��ể đóng sidebar */}
      {isOpen && (
        <div
